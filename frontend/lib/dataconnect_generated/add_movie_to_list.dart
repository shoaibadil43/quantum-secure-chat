...
class AddMovieToListVariablesBuilder {
  ...
  MutationRef<AddMovieToListData, AddMovieToListVariables> ref() {
    AddMovieToListVariables vars= AddMovieToListVariables(listId: listId,movieId: movieId,position: position,);
...
class AddMovieToListVariables {
  ...
  @override
  int get hashCode => Object.hashAll([listId.hashCode, movieId.hashCode, position.hashCode]);
